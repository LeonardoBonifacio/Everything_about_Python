...
at the same time, so that Voldemorts was suddenly a flaming {noun2}. Harry heard the high voice \
shriek as he too {verb_past} his best hope to the heavens, pointing Dracos {noun3}:\n\
\"{spell1}!\"\n\
\"{spell2}!\"\n\
...
{noun_plural} collided. Harry saw Voldemorts {adj3} jet meet his own spell, saw the Elder Wand \
...
staring down at his enemys {noun6}."
...
def hungergames():
    ...
    madlib=f"{number} seconds. Thats how long were required to {verb} on our metal circles before \
