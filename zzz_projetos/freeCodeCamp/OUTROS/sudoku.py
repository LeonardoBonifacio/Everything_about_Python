...
def solve_sudoku(puzzle):
    ...
    # our puzzle is a list of lists, where each linner list is a row in our sudoku puzzle
    # return whether a solution exists
    # mutate puzzle to be the solution (if solutions exists) 

    # step 1: choose somewhere on teh puzzle to make a guess
