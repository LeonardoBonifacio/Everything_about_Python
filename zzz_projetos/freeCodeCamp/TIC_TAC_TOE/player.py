...
class HumanPlayer(Player):
    ...
    def get_move(self,game):
        ...
        while(not valid_square):
            ...
            # It to an interefer, and if it's not, then we say its invalid
...
class GeniusComputerPlayer(Player):
    ...
    def minimax(self, state, player):
        ...
        # first, we want to check if the previos move is a winner
        ...
        for possible_move in state.available_moves():
            ...
            # step 2: recures using minimax to simulate a game after making that move
