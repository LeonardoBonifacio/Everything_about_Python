...
def clientes(request):
    if request.method == "GET":
        ...
        # Se o  email não corresponder a essa regular expression
...
def att_cliente(request):
    ...
    #Convertendo um objeto de uma Model em json atraves do serializer do Django
...
@csrf_exempt # Indica que para qualquer formulário que envie dados para essa view, não há necessidade do uso do csrf_token
...
def excluir_carro(request,id):
    try:
        ...
        # reverse pega o nome que eu dei a url e a substitui pela url de fato
        return redirect(reverse('clientes')+f'?aba=att_cliente&id_cliente={id}')
