...
SECRET_KEY = 'django-insecure-ue&t2=)-=_l3th$t0nip!4z-^vgc5#)zujkqbd1xe#5-$ga!00'
...
#Link pra onde o usuario vai ser levado quando fizer login
LOGIN_REDIRECT_URL = 'filme:homefilmes'

# View que o usuário faz login
