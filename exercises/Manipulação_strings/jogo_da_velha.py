...
def boasvindas():
    limparTela()
    cabecalho()
    print(f'{("Bem-Vindo ao jogo da Velha!!"):^50}')
    print(f'{"-" * 50}')

def placar(nomeP1, vitoriasP1, nomeP2, vitoriasP2, empates,opcaoUs):
    limparTela()
    cabecalho()
    if(opcaoUs == '1'):
        simboloP1 = 'o'
...
def tabuleiro(c1, c2, c3, c4, c5, c6, c7, c8, c9):
    print(f'{"MAPA DO JOGO":^19}','          ',f'{"JOGO EM ANDAMENTO":^19}')
    print(f'+-----+-----+-----+','          ',f'+-----+-----+-----+')
...
def modoDificil():
    print()
    print('Deseja jogar em qual dificuldade?\n[1] Normal(movimentos aleatórios do computador)\n[2] Difícil(movimentos do computador são calculados)')
    opcao = input('Qual a sua opção? ').strip()
    while(opcao != '1' and opcao != '2'):
        opcao = input('Opção inválida. Qual a sua opção? [1/2] ').strip()
    if(opcao == '1'):
...
def nivelDificil(c1, c2, c3, c4, c5, c6, c7, c8, c9, pc):
    ...
    #Vai sugerir casa 5
    if(c5 == ' '):
        if(c4 == pc and c6 == pc or c2 == pc and c8 == pc or c1 == pc and c9 == pc or c3 == pc and c7 == pc):
    ...
    #Vai sugerir casa 7
    if(c7 == ' '):
        if(c1 == pc and c4 == pc or c8 == pc and c9 == pc or c5 == pc and c3 == pc):
            listaOpcoes1.append(7)
    #Vai sugerir casa 8 
    if(c8 == ' '):
        if(c7 == pc and c9 == pc or c5 == pc and c2 == pc):
            listaOpcoes1.append(8)
    #Vai sugerir casa 9 
    if(c9 == ' '):
        if(c8 == pc and c7 == pc or c5 == pc and c1 == pc or c6 == pc and c3 == pc):
    ...
    #Vai sugerir casa 3
    if(c3 == ' '):
        if(c1 == adv and c3 ==  adv or c6 == adv and c9 ==  adv or c5 == adv and c7 == adv):
            listaOpcoes2.append(3)
    #Vai sugerir casa 4
    if(c4 == ' '):
        if(c1 == adv and c7 == adv or c5 == adv and c6 == adv):
            listaOpcoes2.append(4)
    #Vai sugerir casa 5
    if(c5 == ' '):
        if(c2 == adv and c8 == adv or c4 == adv and c6 == adv or c1 == adv and c9 == adv or c3 == adv and c7 == adv):
            listaOpcoes2.append(5)
    #Vai sugerir casa 6
    if(c6 == ' '):
        if(c3 == adv and c9 == adv or c4 == adv and c5 == adv):
            listaOpcoes2.append(6)
    #Vai sugerir casa 7
    if(c7 == ' '):
        if(c1 == adv and c4 == adv or c5 == adv and c3 ==  adv or c8 == adv and c9 == adv):
            listaOpcoes2.append(7)
    #Vai sugerir casa 8
    if(c8 == ' '):
        if(c7 == adv and c9 == adv or c5 == adv and c2 == adv):
            listaOpcoes2.append(8)
    #Vai sugerir casa 9
    if(c9 == ' '):
        if(c3 == adv and c6 == adv or c7 == adv and c8 == adv or c5 == adv and c1 == adv):
    ...
    if(c5 == ' '):
        ...
        if(c3 == pc and c7 == ' ' or c7 == pc and c3 == ' '):
            listaOpcoes3.append(5)
        if(c1 == pc and c9 == ' ' or c9 == pc and c1 == ' '):
            listaOpcoes3.append(5)
    #Vai sugerir casa 6
    if(c6 == ' '):
...
- O objetivo é conseguir três círculos ou três
...
while(True):
    ...
    empates = 0
    proximoJogador = ''
    #Variáveis dos campos do tabuleiro
    c1 = ' '
    c2 = ' '
    c3 = ' '
    c4 = ' '
    ...
    nomeP1 = str(input('Qual o seu nome? ')).title()
    if(opcaoUsuario == '1'):
        simboloP1 = 'o'
        simboloP2 = 'x'
    elif(opcaoUsuario == '2'):
    ...
    if(jogadores == '2'):
        nomeP2 = str(input('Qual o nome do segundo jogador? ')).title()
    else:
        dificil = modoDificil()
        nomeP2 = 'Computador'
    ...
    while(True):
        if(jogada == 'sair'):
            ...
            vitoriasP1 = vitoriasP2 = empates = 0
            c1 = ' '
            c2 = ' '
            c3 = ' '
            c4 = ' '
        ...
        while(True):
            ...
            if(jogada.isnumeric()):
                if(int(jogada) >= 1 or int(jogada) <= 9):
                    ...
                    if(jogadores == '2'):
                        print('Opção inválida, por favor escolha um casa que esteja disponível e digite seu número!')
            else:
                if(jogadores == '2'):
                    print('Opção inválida, por favor escolha uma casa que esteja disponível e digite sue número!')
        if(jogadores == '1' and proximoJogador == 'Computador'):
        ...
        if(verificarVencedor(c1, c2, c3, c4, c5, c6, c7, c8, c9)):
            ...
            if(jogadores == '1' and proximoJogador == nomeP2):
                ...
                print(f'Parabens {proximoJogador}({proximoSimbolo}), você venceu!')
